...
## Communication
- [Sign up to receive emails when we release new versions of the SDK](http://eepurl.com/_c1K9). When a new version is released, we will email you, as well as post a tag in the [Releases section](https://github.com/modestinc/modest_sdk_ios/releases) and update the [CHANGELOG.md](CHANGELOG.md) file.
